...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { body: @testimonial.body, name: @testimonial.name } }, as: :json
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { body: @testimonial.body, name: @testimonial.name } }, as: :json
    assert_response 200
  end
